...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1523: x0 => new Uint8Array(x0),
      _1531: x0 => new Int32Array(x0),
      _1535: x0 => new Float32Array(x0),
      _1537: x0 => new Float64Array(x0),
      _1569: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1570: () => new TextDecoder("utf-8", {fatal: true}),
      _1571: () => new TextDecoder("utf-8", {fatal: false}),
      _1572: (s) => parseFloat(s),
      _1573: x0 => new WeakRef(x0),
      _1574: x0 => x0.deref(),
      _1580: Date.now,
      _1582: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1583: s => {
      ...
      _1619: (a, i) => a.push(i),
      _1623: a => a.pop(),
      _1624: (a, i) => a.splice(i, 1),
      _1625: (a, s) => a.join(s),
      _1626: (a, s, e) => a.slice(s, e),
      _1629: a => a.length,
      _1631: (a, i) => a[i],
      _1632: (a, i, v) => a[i] = v,
      _1634: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1637: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1638: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1639: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1640: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1641: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1643: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1644: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1645: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1646: (t, s) => t.set(s),
      _1648: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1650: o => o.buffer,
      _1651: o => o.byteOffset,
      _1652: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1653: (b, o) => new DataView(b, o),
      _1654: (b, o, l) => new DataView(b, o, l),
      _1655: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1656: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1657: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1658: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1659: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1660: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1661: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1662: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1663: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1664: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1665: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1666: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1669: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1670: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1671: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1672: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1673: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1674: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1687: (o, t) => o instanceof t,
      ...
      _1701: (x0,x1) => x0.exec(x1),
      _1702: (x0,x1) => x0.exec(x1),
      _1703: x0 => x0.pop(),
      _1705: o => o === undefined,
      ...
      _1749: l => arrayFromDartList(Array, l),
      _1750: () => ({}),
      _1751: () => [],
      _1753: () => globalThis,
      ...
      _1768: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI32ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1769: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _1770: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF32ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1771: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF64ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _1772: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1776: x0 => x0.index,
      _1781: x0 => x0.flags,
      _1782: x0 => x0.multiline,
      _1783: x0 => x0.ignoreCase,
      _1784: x0 => x0.unicode,
      _1785: x0 => x0.dotAll,
      _1786: (x0,x1) => x0.lastIndex = x1,
      _1787: (o, p) => p in o,
      _1788: (o, p) => o[p],
      _1791: x0 => x0.random(),
      _1792: x0 => x0.random(),
      _1796: () => globalThis.Math,
      _1798: Function.prototype.call.bind(Number.prototype.toString),
      _1799: Function.prototype.call.bind(BigInt.prototype.toString),
      _1800: Function.prototype.call.bind(Number.prototype.toString),
      _1801: (d, digits) => d.toFixed(digits),
...
"Too few arguments passed. Expected 3 or more, got ",
